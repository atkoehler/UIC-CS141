...
void printMenu();
int readData(vector<string> &, const string&);
void trimEnd(string &);
...
/// @param filename the filename to use for input
/// @return the quantity of words read (valid and invalid)
int readData(vector<string> &data, const string &filename)
{
    int counter = 0;
