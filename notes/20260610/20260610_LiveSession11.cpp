...
void LinkedListExamples()
{
    ...
    Person* a = new Person("Alice", 24);
    Person* b = new Person("Bob", 35);
    Person* c = new Person("Charlie", 17);
    Person* d = new Person("Dory", 93);
    Person* e = new Person("Elaine", 72);
    Person *f = new Person("Francine", 53);
    ...
    // creating a scope to invoke destructors before end of program
    {
        ...
        allLines.front()->joinLine(new Person("George", 43));
    ...
    cout << "==========================================" << endl;
    Line another;
    another.joinLine(new Person("Perry", 25));
    Line anotherTwo;
    anotherTwo.joinLine(new Person("Sam", 56));
    cout << "List was: " << endl;
    anotherTwo.print();
    cout << endl << endl;
    anotherTwo = another;
    ...
    cout << endl << endl;
    three->joinLine(new Person("Tyler", 14));
    three->joinLine(new Person("James", 23));
    three->joinLine(new Person("Sara", 32));
